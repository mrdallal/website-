/**
 * Editorial hero composition: a dark "system panel" showing the attention →
  ...
  return (
    <div className="relative mx-auto max-w-[520px] lg:ml-auto lg:mr-0" aria-hidden="true">
      ...
      <div className="relative border border-bone/15 bg-surface p-6 text-bone shadow-hard-lime sm:p-8">
                    ...
                    className={
                      isActive
                        ...
                        : isLast
                          ...
                          : "size-2.5 shrink-0 bg-bone/30"
                    }
                  />
                  {!isLast ? <span className="w-px flex-1 bg-bone/10" /> : null}
                </div>
                      ...
                      className={
                        isLast
                          ...
                          : isActive
                            ...
                            : "text-h4 font-medium text-bone/60"
                      }
                    >
                      {step}
                    </span>
        ...
        <div className="mt-6 grid grid-cols-3 gap-px border border-bone/10 bg-bone/10">
          {[
            { k: "Leads", v: "→ OS" },
            { k: "Follow-up", v: "Auto" },
            { k: "Visibility", v: "100%" },
          ].map((cell) => (
            <div key={cell.k} className="bg-surface px-3 py-3">
      ...
      {/* Floating lead card */}
      <div className="absolute -right-3 top-10 hidden w-56 border border-bone/15 bg-raised p-4 text-bone shadow-panel sm:block lg:-right-8">
        <div className="flex items-center justify-between">
          <span className="micro-mono text-mute">Lead</span>
          <span className="micro-mono bg-lime px-1.5 py-1 text-ink">New</span>
        </div>
        <p className="mt-3 text-sm font-semibold">Captured · Qualified · Routed</p>
